...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
    ...
    <style>
  <?php
  include'common/css/milk_manage.css';
  ?>
</style>
...
<script type="text/javascript">
    <?php
      include 'common/js/milk_manage.js';
    ?>
</script>
...
<div class="nav">
   ...
   <!--  <div>
    ...
    <div>
      ...
      <i class="fa fa-shopping-bag" style="font-size:25px;color:white;text-align: right;margin-top: 8%">
        <?php if($cardcount) { ?>
...
<div class="container">
  <div class="row">
       <p style="color:gray;padding:4%;margin:0 auto;font-family: arial;font-weight:600;font-size:20px;letter-spacing: 1px;">Milk Product</p>
       <div>
       
     </div>
       <div class="mainContent col-md-12" id="mainContent2" style="margin-top:2%;margin-bottom:2%;display: flex;flex-wrap: wrap;justify-content: center;"></div>
  </div>
</div>
...
$(document).ready(function(){
  $("#gsearch").on("keyup", function() {
    ...
    $("#mainContent2 .img_contain").filter(function() {
