...
<head>
  ...
  <style>
  <?php
  include'common/css/feature.css';
  ?>
</style>

<script type="text/javascript">
    <?php
      include 'common/js/feature.js';
    ?>
</script>
...
<div class="container">
  <div class="row">
        <p style="color:gray;padding:4%;margin:0 auto;font-family: arial;font-weight:600;font-size:20px;letter-spacing: 1px;">Featured</p>
        <div>
