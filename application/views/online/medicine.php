...
<head>
 ...
 <style>
  <?php
  include'common/css/medicine.css';
  ?>
</style>
...
<div class="container">
  <div class="row">
        <p style="color:gray;padding:4%;margin:0 auto;font-family: arial;font-weight:600;font-size:20px;letter-spacing: 1px;">Medicine</p>
